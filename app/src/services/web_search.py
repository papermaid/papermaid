...
class BingSearchClient:
    ...
    def format_search_results(self, response):
        ...
        formatted_results = []
        formatted_results.append(f"Original Query: {response['queryContext']['originalQuery']}")
        formatted_results.append(f"Total Estimated Matches: {response['webPages']['totalEstimatedMatches']}")
        formatted_results.append(f"Web Search URL: {response['webPages']['webSearchUrl']}\n")
