...
class ConstructGraphPage:
    ...
    def process_files(self, files):
        ...
        """
        for file in files:
            self.knowledge_graph_manager.construct_graph(file)
    ...
    def handle_input(self):
            ...
            if st.session_state["user_input"]:
                ...
                if output:
                    st.session_state["generated"].append("Constructing graph knowledge from topic: " + user_input + " Successful")
                else:
                    st.session_state["generated"].append("Fail to construct graph knowledge from topic: " + user_input)
    ...
    def write(self, use_graph: bool = False):
        ...
        if uploaded_files:
            ...
            if new_files:
                ...
                st.success(f"Successfully constructing grap knowledege from {len(new_files)} file(s)")
